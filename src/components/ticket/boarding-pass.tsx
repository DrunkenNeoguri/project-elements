...
export default function BoardingPassTicket(props: TravelBasicType) {
  ...
  useEffect(() => {
    setQrCode(
      new QRCodeStyling({
        ...
        height: 100,
        data: `/element?id=${id}`,
        image: "https://localhost:3000/icon-foreign.svg",
        dotsOptions: {
          color: "#FFFFFF",
          type: "rounded",
        },
  ...
  return (
    ...
    >
      <div className="bg-primary text-white flex min-w-[22px] rounded-l">
      ...
      <div className="bg-primary text-white flex flex-col justify-start items-center min-w-[88px] gap-[10px] ml-auto mr-0 my-2 rounded-l p-2">
        <span className="font-medium10 text-left">BOARDING PASS</span>
