...
export default function ResetForm() {
  ...
  return (
    <>
      <Form onSubmit={handleSubmit} formData={resetData} setFormData={setResetData} styles="px-4">
        <div className="flex flex-col mb-3">
          <Form.Label htmlFor="password">새 비밀번호</Form.Label>
          <Form.Input id="password" type="password" />
          <Form.ErrorText>{changePasswordErrorMsg(resetData.password)}</Form.ErrorText>
        </div>
        ...
        <div className="flex flex-col mb-3">
          ...
          <Form.ErrorText>
            {changeConfirmPasswordErrorMsg(resetData.password, resetData.confirmPassword)}
          </Form.ErrorText>
        </div>
