...
export default function TravelCreate() {
  const { currentStep, setCurrentStep, activeCover, setActiveCover, travelData, setTravelData } =
    useTravelCreate();
  ...
  const componentSteps = [
    <SelectSection handleNextStep={handleMoveNextStep} setTravelData={setTravelData} />,
    <TravelForm
    ...
    <ConfirmSection
      ...
      setTravelData={setTravelData}
    />,
    <TemplateSection handlePrevStep={handleMovePrevStep} travelData={travelData} />,
  ];

  return (
    <>
      <Stepper currentStep={currentStep} />
      <ChangeCover animation={activeCover}>{componentSteps[currentStep]}</ChangeCover>
    </>
  );
}
